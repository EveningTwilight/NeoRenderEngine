...
| Shader 反射 | ✅ 已完成 | 统一的 Shader 参数反射与绑定机制 |
| Shader 库管理 | ✅ 已完成 | 支持 .metallib 加载与管理 |
...
| 特性 | 状态 | 描述 |
| --- | --- | --- |
| 场景图 (Scene Graph) | ✅ 已完成 | 节点层级管理 (Node/Transform) |
| 组件化架构 (Component System) | ✅ 已完成 | 灵活的组件挂载 (MeshRenderer, CameraComponent) |
| 相机系统 | ✅ 已完成 | 透视/正交相机 |
...
## 5. 多媒体与 2D 能力 (Multimedia & 2D)
| 特性 | 状态 | 描述 |
| --- | --- | --- |
| 图片加载 | ✅ 已完成 | 支持 PNG/JPG 纹理加载 |
| 视频渲染 | ❌ 不支持 | 暂无视频纹理支持 (计划 v1.1) |
| 文本渲染 | ❌ 不支持 | 暂无字体渲染支持 (计划 v1.2) |
| 2D 精灵/UI | ❌ 不支持 | 暂无 2D 批处理渲染 (计划 v1.2) |
